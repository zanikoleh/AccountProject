...
namespace DataAccess.Repositories.impl
{
    public class BankAccountRepository: IBankAccountRepository
    {
        ...
        public void DepositMoney(string username, decimal value)
        {
            ...
            {
                this.UpdateAccountBalance(this.GetAccount(username), value);
            }
        }
        ...
        /// <param name="value"></param>
        public void UpdateAccountBalance(BankAccounts account, decimal value)
        {
        ...
        public void WithdrawMoney(string userName, decimal value)
        {
            ...
            else
            {
                ...
                {
                    this.UpdateAccountBalance(user, value);
                }
            }
        }
