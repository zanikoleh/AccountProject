[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(AccountProject.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(AccountProject.Web.App_Start.NinjectWebCommon), "Stop")]
...
namespace AccountProject.Web.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IRepositoryBase>().To<RepositoryBase>();
